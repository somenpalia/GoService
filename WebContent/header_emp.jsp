 ...
 --%>		<div class="dropdown" style="float: left;">
			...
			<div class="dropdown-content" style='width: 98%; height: 70px;'>
				...
				<table>
					...
					<tr>
						<td><a href="${pageContext.request.contextPath}/JSP/add_delivery_boys.jsp" style='color: blue;'>Add<br></a>
						</td>
					</tr>
			...
			<div class="dropdown" style="float: right;">
				<a href="../emp_logout" style="color: blue"><button
			...
			<button class="dropbtn">
					Hello!
					<%=name%></button>
			<div class="dropdown-content" style='width:30%%; height:20%; float:right;'>

				<table>
					<tr>
						<th><a href="${pageContext.request.contextPath}/JSP/emp_login.jsp"><h4>Login</h4></a></th>
					</tr>
					
					<tr>
						<th><a href="${pageContext.request.contextPath}/JSP/employee_register.jsp"><h4>Sign up ? </h4></a></th>
					</tr>
