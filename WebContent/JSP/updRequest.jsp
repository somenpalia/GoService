...
<body>
	...
	<%
	                ...
	                if(check==null){
	                	...
	                	list=dao.fetchUpdReq(id);
		                session.setAttribute("updlist",list);
	                }else{
	                	list=(ArrayList<FetchedReqBo>)request.getAttribute("newlist");
	                	session.setAttribute("updlist",list);
	                }
	%>
	...
	<div class='header'>
		<div class='header-in'>
			<a href='/GoService/JSP/scHome.jsp'> <img src='/GoService/Images/logo.png'><br>
			</a>
		</div>
		<div class='header-in'
	...
	<div style='float: left; width: 100%;'>
		<table class='displayTable'>
			...
			<tr>
				...
				<td><a href="/GoService/updReqController?index=<%=index%>" style='color:blue;'>Update</a></td>
			</tr>
			<%
				}
				}else{
			%>
	<center>		<h1>All requests completed</h1>  </center>
			<%
				}
			%>
			<tr>
